        ...
        <div className="w-full max-w-5xl flex flex-col md:flex-row justify-between items-center mb-8 m-20">
          <div>
            ...
            <p className="text-[#333] text-sm md:text-base max-w-xl">
              This is the official page of Testwale, where you can share all
              your queries, feedback, explanations, or any concerns you have
              about our lessons and progress.
            </p>
            <p className="text-[#001E32] font-semibold text-2xl mt-6">
              Hello Sam
            </p>
          </div>
