                  ...
                  <div className="bg-white border border-solid border-[#d9d9d9] p-8 rounded-md">
                    <div className="grid gap-6">
                      ...
                      <div className="flex items-center gap-4 mt-4">
                        <input type="Number" value={time} onChange={handleTimeChange} className="w-[45px] bg-white border border-solid border-gray-300 pl-2.5 p-1 rounded shadow-sm inline-block font-medium text-[#2f2f68] text-xl" />
                    ...
                    <div className="mt-8 flex justify-center">
                      <button
                        type="submit"
                        className={`bg-[#001e32] text-white font-semibold text-xl py-3 px-6 rounded-md ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                        disabled={loading}
                      >
